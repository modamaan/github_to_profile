...
export function BuyMeCoffeeButton() {
    return (
        <a
            ...
            className="fixed bottom-6 right-6 z-50 w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-lime-300 to-lime-400 rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 flex items-center justify-center group"
        ...
        >
            ...
            <svg
                ...
                className="text-gray-800 relative z-10 w-7 h-7 md:w-8 md:h-8"
            >
                <path
